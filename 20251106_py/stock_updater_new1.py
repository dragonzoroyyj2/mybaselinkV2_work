...
try:
    ...
    # DART API 키는 이 스크립트와 분석 스크립트 모두에서 필요합니다.
...
def fetch_and_save_data(item):
    ...
    # 3년치 데이터를 가져와서 분석에 충분한 기간을 확보합니다.
    ...
    try:
        ...
        # 필요한 컬럼만 추출하고 인덱스를 리셋합니다.
        df = df[['Open', 'High', 'Low', 'Close', 'Volume']].reset_index()
        # 파일을 Parquet 형식으로 저장하여 효율성을 높입니다.
